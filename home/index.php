    ...
    <div class="row">
      ...
      <div class="col-sm-10" style="height: 100%;">
        <div>
              ...
              <div class="gradient" style="min-height: auto;padding:15px;-webkit-box-shadow: 0px 4px 25px -5px rgba(0,0,0,0.10);-moz-box-shadow: 0px 4px 25px -5px rgba(0,0,0,0.10); box-shadow: 0px 4px 25px -5px rgba(0,0,0,0.10);margin-bottom: 15px;">
                <div class="row">
                  ...
                  <div class="col-sm-12 dragContainer">
                    <div class=" wrapper">
                      <div class="projectHorzScroll" id="activeProjects"> </div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="whitebg"> <i class="fa fa-refresh pull-right" aria-hidden="true" id="refreshFeed"></i>
                <div class="header">
                ...
                <div class="newsfeedContainer">
                  <div id="printNewsfeed">
                    <center>
                      <img src="/dashboard/images/grey-spinner.gif" id="spinner">
                    </center>
                  </div>
                </div>
              </div>
