      ...
      <div class="row">
		 ...
		 <div class="col-sm-12">
			<div class="whitebg">
				...
				<div id="noUserPage"><center><br><br><h1 class="text-center">This user has been deleted or does not exist.</h1>
					<br>
					<a href="/dashboard/users" class="genericbtn noExpand">User Directory</a></h3></center></div>
    	 	<div  id="loadingPage">
			<div class="header">
			...
			<div class="col-sm-12">
   	 		...
   	 		<div class="row">
    	 		<div class="col-sm-4">
    	 			<center><img src='' style='max-height: 300px;' id="printProfilePic"></center>
					...
					<p><div class="formLabels">Email:</div> <a href='' id="printEmail"></a></p>
    	 		...
    	 		<div class="col-sm-12">
					...
					<div id="printNewsfeed" style="max-height: 700px; overflow: scroll">
