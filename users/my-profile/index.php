          ...
          <div class="whitebg">
            ...
            <div  id="loadingPage">
              ...
              <div class="row">
                <div class="col-sm-4">
                  <center>
                    <div id="changeProfilePictureBtn" data-toggle='modal' data-target='#changeProfilePicture' class="circlebtn primaryColorBG"><i class="fa fa-camera" aria-hidden="true"></i></div>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        ...
                        <div class="tab-content">
                          ...
                          <div id="content5" class="tab-pane fade in"> <br>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-sm">
          <div class="row">
            <div class="col-sm-12">
              <div class="formLabels">Profile Picture:</div>
              <input type="file" id='myPP'>
              <br>
            </div>
          </div>
        </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-sm">
          <div class="row">
            <div class="col-sm-12">
              <div class="formLabels">My Title:*</div>
              <input type="text" id="myTitle" class="validate" value="<?php echo $Title ?>">
              <div class="formLabels">My Email:*</div>
              <input type="text" id="myEmail" class="validate" value="<?php echo $Email ?>">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-sm">
          <div class="row">
            <div class="col-sm-12">
              <div class="formLabels">Current Password:*</div>
              <input type="password" class="validate" id='currentPassword'>
              <br>
              <div class="formLabels">New Password:*</div>
              <input type="password" class="validate" id="newPassword">
              <div class="formLabels">Confirm New Password:*</div>
              <input type="password" class="validate" id="confirmNewPassword">
              <p id="message"></p>
            </div>
          </div>
        </div>
