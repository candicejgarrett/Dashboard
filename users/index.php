        ...
        <div class="col-sm-12" id="moveOver">
          <div class="whitebg">
            ...
            <div class="sorter row">
              ...
              <div class="col-sm-4">
                <p>Role:
                  <select name="RoleNameList" id="sortRole" style="margin-top: 10px !important;">
              ...
              <div class="col-sm-4">
                <p>Team Name:
                  <select name="GroupNameList" id="sortGroup" style="margin-top: 10px !important;">
                    <option value="All">Show All</option>
                    <?php
            ...
            <div id="loadingPage">
              <div class="row" style="padding: 5px;" id="printMembers"> </div>
            </div>
          </div>
        </div>
      </div>
