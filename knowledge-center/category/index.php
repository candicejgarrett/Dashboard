		 ...
		 <div class="col-sm-12">
			<div class="whitebg">
    	 	<div class="header">
					...
					<h3><a style="color:#333;" href="/dashboard/knowledge-center/">Knowledge Center:</a> <strong><a href="/dashboard/knowledge-center/category/?cat=<?php echo $KCcategory;?>"><?php echo $KCcategory;?></a></strong>  <em><?php if (isset($KCTag2)) {echo "> ".$KCTag2;}?></em></h3>
       		...
       		<div class="col-sm-6">
				...
				<div id="printPostTags" style="display:inline-block">
      			...
      			<div class="col-sm-12"><br>
      				<button id="addNewPost-btn" style="margin-left:0px;" class="genericbtn" type="submit" name="new" categoryID="<?php echo $KCcategoryID;?>">Add New Post</button><br><br>
      			</div>
