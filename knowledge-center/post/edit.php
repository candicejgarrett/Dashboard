       		...
       		<div class="col-sm-12">
       			<div class="row blogPost">
       				...
       				<div class="col-sm-10">
       					...
       					<h3><div class="formLabels">Title:*</div><input id="updateTitle" class="validate" type="text" value="<?php echo $postTitle ?>"></input></h3>
      			...
      			<div class="selectTags">
       				...
       				<br><button class="save" id="savePost-btn" postID="<?php echo $postID ?>" categoryID="<?php echo $postCategoryID ?>"><i class="fa fa-floppy-o" aria-hidden="true"></i></button>
       			</div>
