    ...
    <div class="col-sm-10" style="height: 100%;">
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="whitebg">
            <div class="header">
              <button id="createNewPost-btn" class="pull-right createNew" style="margin-top:-25px;"><i class="fa fa-plus" aria-hidden="true"></i>
              <div class="btnExpand">Create New Post</div>
              </button>
            ...
            <div class="row" id="createNewPost">
              ...
              <div class="col-sm-6">
                ...
                <div class="selectTags" style="loat: left !important;margin-bottom: 10px;"> </div>
              </div>
              <div class="col-sm-12">
                <textarea id="postBody" name="postBody"></textarea>
              </div>
              <div class="col-sm-12"><br>
                <button id="addNewPost-btn" style="margin-left:0px;" class="genericbtn" type="submit" name="new" categoryID="<?php echo $postCategoryID;?>">Add New Post</button>
                <br>
                <br>
              </div>
            </div>
              ...
              <div class="col-sm-12">
                <div class="row blogPost">
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="lastUpdated">Last Updated By: <?php echo $postLastUpdatedBy." @ ".$postLastUpdated ?></div>
                    <?php
                    ...
                    ?>
                    <hr>
                    <div class="postBody"><?php echo $postBody ?></div>
                  </div>
                </div>
              </div>
            </div>
