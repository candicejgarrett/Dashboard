$(document).ready(function () {
  ...
  $(document).on("click", "#editProject-btn", function () {
    ...
    var dataString = {
      'type': "editLoad",
      'editingProjectID1': editingProjectID
    };
  ...
  $("#editProjectModal-btn").on('click', function () {
    ...
    var dataString = {
      'type': "save",
      'projectID': projectID,
      'title': projectTitleEdit,
      'dueDate': projectDueDateEdit,
      'categoryID': projectCategoryEdit,
      'description': projectDescriptionEdit,
      'visibility': projectVisibleEdit,
      'folderLink': projectFolderEdit,
      'url': projectURLEdit
    };
  ...
  $(document).on('click', '#addNewTaskModal-btn', function () {
    ...
    if (addTaskMember === '') {
      ...
      var dataString = {
        ...
        'taskTitle1': taskTitle,
        'taskDueDate1': taskDueDate,
        'taskCategory1': taskCategory,
        'taskDescription1': taskDescription,
        'addTaskMember1': addTaskMember,
  ...
  $(document).on('click', '#editTaskModal-btn', function () {
    ...
    if ($('#taskEndDateEdit').val() < $('#taskDueDateEdit').val()) {
      ...
      var dataString = {
        'type': "save",
        'taskTitleEdit': taskTitleEdit,
        'taskDueDateEdit': taskDueDateEdit,
        'taskCategoryEdit': taskCategoryEdit,
        'taskDescriptionEdit': taskDescriptionEdit,
        'taskStatusEdit': taskStatusEdit,
        'taskID': taskID,
        'taskMessageEdit': taskMessageEdit,
        'taskEndDateEdit': taskEndDateEdit,
        'eventCategoryEdit': eventCategoryEdit
      };
  ...
  $(document).on("click", "#sendNote", function () {
    ...
    var dataString = {
      ...
      'mentionUserIDs': mentionUserIDsJson
    };
