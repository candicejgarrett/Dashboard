			 ...
			 <div class="col-sm-12">
				<div class="whitebg" style="min-height: auto !important;">
						<div class="row">
							...
							<h1>You have successfully unsubscribed from<br><strong><?php echo $categoryName ?></strong> Content Calendar events.</h1>
								<br>
								<p class="text-center">You can opt back in or change other email settings from your profile.</p>
								<br>
							<a href="/dashboard/users/me.php" class="genericbtn noExpand" style="margin-right:10px;">My Profile</a>
								<a href="/dashboard/content-calendar/" class="genericbtn noExpand">Content Calendar</a>
