      		...
      		<div class="col-sm-12">
      			<div class="whitebg">
					...
					<div class="sorter row">
						...
						<div class="col-sm-2">
						<div class="formLabels">Team:</div><?php
      			...
      			<div class="row" id="createNewProject">
						...
						<div class="col-sm-12">
						<a href="templates/" class="genericbtn pull-right" style=" margin-top: 10px;">Project Templates</a>
       		...
       		<div class="col-sm-6">
      			...
      			<input type="text" id="projectTitle" name="projectTitle" placeholder="" class="validate"><br>
     			...
     			<div class="formLabels">Project Folder Link:</div>
      			...
      			<pre style="padding: 0px !important;"><textarea id="projectDescription" placeholder=""></textarea></pre>
     			</div>
     			<br>
      			<div class="col-sm-12">
