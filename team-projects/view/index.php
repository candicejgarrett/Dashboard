...
<style>
	...
	.sorter,.printFilter {display:none;}
	#taskStatusEdit2 {display:none;}
	#printActivities .feed-item p{color:#ffffff !important;}
</style>
			...
			<?php include("../../templates/alerts.php") ?>
      		...
      		<!--<div class="gradientBackground"><p class="daysLeft">This project was completed in <strong>3</strong> days.</p></div>-->
      			<div class="whitebg" style="margin-bottom: 0px;">
					...
					<div class="header"><span id="canEditProject" class="pull-right" style="margin-top:-10px;"></span>
					<span id="favorite"></span>
						<h3 id="printProjectTitle"></h3>
					</div>
					<div class="row">
						<div class="col-sm-4">
						<p><div class="formLabels">Created By: </div><span id="printProjectCreatedBy"></span></p>
						<p><div class="formLabels">Status:</div> <em><span id="printProjectStatus"></span></em></p>
						
						<p><div class="formLabels">Project Folder Link:</div><span id="printProjectFolder" style="word-wrap: break-word;"></span></p>
						<p><div class="formLabels">URL:</div><a href="" id="printProjectURL" style="word-wrap: break-word;color:#000000" target="_blank"></a></p>
						
						</div>
						<div class="col-sm-5">
						<p><div class="formLabels">Due Date:</div> <em><span id="printProjectDueDate"></span></em></p>
						<p><div class="formLabels">Category:</div> <em><span id="printProjectCategory"></span></em></p>
						<p><div class="formLabels">Visibility:</div> <em><span id="printVisible"></span></em></p>
						</div>
		
						<div class="col-sm-3">
							<h1 class="projectPercentage pulse pull-right"><img src="../../images/Spinner.gif"></h1>
							
							<div id="printCopyLink"><center><div class="copyLink"><i class="fa fa-link" aria-hidden="true"></i> Share</div></center><input type="text" id="copyLinkInput"></div>
						</div>
					
					<div class="col-sm-12">
      				<p><div class="formLabels">Project Description:</div>
					<em><pre class="text-scroll" id="printProjectDescription"></pre></em></div></p>
      		...
      		<div class="col-sm-12">
      			...
      			<div class="header">
      				<span id="canAddTask"></span>
						...
						<div class="col-sm-2">
						<div class="formLabels">Requested By:</div><?php
					...
					?>
						...
						<button class="genericbtn goFilter" style="margin-left: 0px;margin-right: 7px;">Filter</button><button class="genericbtn clearFilters" style="margin-left: 0px;background:#ff0000 !important;">Clear</button>
					...
					<div class="row">
					<div class="col-sm-12">
     			<div class="pull-right"><div class="formLabels">Sort:</div><select name="sortBy" class="sortBy">
      		...
      		<div class="col-sm-6">
       		...
       		<div class="col-sm-6" id="ProjectNotes">
      			...
      			<div class="header">
					...
					<div id="printMessages">
      						
      					</div>	
					</div>
      					<br>
						<span id="canMention"></span>
      					<span id="canAddNote"></span>
       			</div>
      		...
      		<div class="col-sm-12">
      			...
      			<span id="canAddCopy"></span>
      				...
      				<div class="row">
     						...
     						<h4>Update</h4>
     						<textarea id="requestCopyEdit" name="requestCopyEdit"></textarea>
     						<br>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        		<div class="form-sm">
        			<div class="row">
						<div class="col-sm-12">
						<div class="formLabels">Title:*</div> <input type="text" id="taskTitle" name="taskTitle" placeholder="" style="width:100%" class="validate">	
						</div>
					</div>
      				<div class="row">
      					<div class="col-sm-6">
					...
					?>
						...
						<div class="col-sm-6">
							<div class="formLabels">Due Date:*</div> <input type="datetime-local" id="taskDueDate" name="taskDueDate" style="width:100%" class="validate">
						</div>
      				...
      				<div class="row">
						<div class="col-sm-12">
							<div class="formLabels">Assign to:* </div>
      						<select name="addTaskMembershipList" id="printMembersDropdown" style="width:100%" class="validate"><option value="">Select</option>
      						</select>
						</div>
       				...
       				<div class="row">
						<div class="col-sm-12">
							<div class="formLabels">Description:</div><pre style="padding:0px !important"><textarea id="taskDescription" name="taskDescription" style="width:100%"></textarea></pre>
						</div>
					</div>
      	...
      	<table border="0" cellspacing="0" cellpadding="5" id="reassignTask">
			  <tbody>
				<tr>
				  ...
				  <td valign="middle"><p>Task Assigned To:<br><strong id="taskAssignedTo"></strong></p></td>
				</tr>
			  </tbody>
		</table>
      </div>
      ...
      <div class="modal-body"  id="viewTaskModal">
		  ...
		  <div class="row">
			  ...
			  <div class="form-sm">
						  	<div class="row">
							<div class="col-sm-6">
							<div class="formLabels">Title:</div> <div id="taskTitleView"></div>
							</div>
							  <div class="col-sm-6">
								<div class="formLabels">Status:</div> <div id="taskStatusView"><strong class='taskStatus'></strong></div>
							</div>
							</div>
							  <br>
							<div class="row">
								<div class="col-sm-6">
									<div class="formLabels">Category: </div>
									<div id="taskCategoryView" style="display: inline-block;"></div><div id="taskEventCategory" style="display: inline-block;"></div>
								</div>
								<div class="col-sm-6">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="formLabels">Description:</div><div id="taskDescriptionView"></div>
							</div>
							</div>
		...
		<div class="modal-body" id="editTaskModal">
			...
			<div class="form-sm">
						  <div class="row">
						<div class="col-sm-12">
						<div class="formLabels">Title:*</div> <input type="text" id="taskTitleEdit" name="taskTitle" placeholder="" style="width:100%" class="validate">
						</div>
					</div>
      				<div class="row">
      				<div class="col-sm-6">
					...
					?>
						...
						<div class="col-sm-6">
							<div class="formLabels">Due Date:*</div> <input type="datetime-local" id="taskDueDateEdit" name="taskDueDate" style="width:100%" class="validate">
						</div>
       				...
       				<div class="row">
						<div class="col-sm-12">
							<div class="formLabels">Description:</div><pre style="padding:0px !important"><textarea id="taskDescriptionEdit" name="taskDescription" style="width:100%"></textarea></pre>
						</div>
					</div>
    ...
    <div class="modal-content">
      	...
      	<table width="100%" border="0" cellspacing="0" cellpadding="5">
			  <tbody>
				<tr>
				  ...
				  <td valign="middle"><p>Project Created By:<br><strong><span id="printProjectCreatedByTop"></span></strong></p></td>
				</tr>
			  </tbody>
		</table>
      </div>
      <div class="modal-body">
       		<div class="form-sm">
						  	<div class="row">
     							<div class="col-sm-12">
									<div class="formLabels">Title:*</div> <input type="text" id="projectTitleEdit" name="projectTitleEdit" placeholder="" style="width:100%" class="validate">
								</div>
							</div>
							<div class="row">
     							<div class="col-sm-6">
     								<div class="formLabels">Due Date:*</div> <input type="datetime-local" id="projectDueDateEdit" name="projectDueDateEdit" style="width:100%" class="validate">
     							</div>
     							<div class="col-sm-6">
     								<div class="formLabels">Category:*</div> 
							...
							<div class="row">
     							<div class="col-sm-6">
     								<strong class="formLabels">Project Folder:</strong>
      								<input type="text" id="projectFolderEdit" name="projectFolder" placeholder="Project Folder Link">
     							</div>
     							<div class="col-sm-6">
     								<strong class="formLabels">Visibility: </strong><select type="text" id="projectVisibleEdit" name="projectVisibleEdit" style="width:100%">
							...
							<div class="row">
     							<div class="col-sm-12">
     								<strong class="formLabels">URL:</strong>
     								<input type="text" id="projectURLEdit" name="projectURL" placeholder="Project URL">
     							</div>
							</div>
							<div class="row">
     							<div class="col-sm-12">
     								<strong class="formLabels">Description:</strong><br><textarea id="projectDescriptionEdit" name="projectDescriptionEdit" style="width:100%"></textarea>
     							</div>
							</div>
						
				<br>
							<button type="button" class="save pull-right" id="editProjectModal-btn" data-dismiss="modal"><i class="fa fa-floppy-o" aria-hidden="true"></i></button><br><br>
     			</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        		...
        		<div id="step1">
        			<div class="row">
						<div class="col-sm-12">
						<div class="formLabels">Title:*</div> <input type="text" id="reviewTitle" name="reviewTitle" style="width:100%" class="validate">
						</div>
					</div>
					
					<div class="row">
						<div class="col-sm-6">
						<div class="formLabels">Type:*</div> <select id="reviewType"><option value="Requester">Requester</option><option value="Content">Content</option></select>
						</div>
						<div class="col-sm-6">
						<div class="formLabels">Due Date:*</div> <input type="datetime-local" id="reviewDueDate" name="reviewDueDate" style="width:100%" class="validate">
						</div>
					</div>
					...
					<li role="presentation" class="active"><a href="#desktopImage" role="tab" data-toggle="tab" class="active one">Desktop Mockup</a>
					  </li>
				  <li role="presentation"><a href="#mobileImage" role="tab" data-toggle="tab" class="two">Mobile Mockup</a>
				  </li>
			</ul>
						...
						<div class="col-sm-12">
							<br>
							<div class="formLabels">Desktop Preview Image:</div> <input type="file" id="desktopPreviewImage" name="desktopPreviewImage[]">
						</div>
						...
						<div class="col-sm-12">
							<br>
							<div class="formLabels">Mobile Preview Image: <input type="file" id="mobilePreviewImage" name="mobilePreviewImage[]"></div>
      					</div>
					</div>
						</div>
    ...
    <div class="modal-content">
      	...
      	<table width="100%" border="0" cellspacing="0" cellpadding="5">
			  <tbody>
				<tr>
				  ...
				  <td valign="middle"><p>Review Created By:<br><strong><span id="reviewCreatedByFullName"></span></strong></p></td>
				</tr>
			  </tbody>
		</table>
      </div>
      <div class="modal-body">
       		<div class="form-sm">
						  	<div class="row">
     							<div class="col-sm-12">
									<div class="formLabels">Title:*</div> <input type="text" id="reviewTitleEdit" name="reviewTitleEdit" placeholder="" style="width:100%" class="validate">
								</div>
							</div>
							<div class="row">
     							<div class="col-sm-6">
     								<div class="formLabels">Due Date:*</div> <input type="datetime-local" id="reviewDueDateEdit" name="projectDueDateEdit" style="width:100%" class="validate">
     							</div>
     							<div class="col-sm-6">
								<div class="formLabels">Type:*</div> 
									<select id="reviewTypeEdit"><option value="Requester">Requester</option><option value="Content">Content</option></select>
								</div>
							</div>
							
						
				<br>
							<button type="button" class="save pull-right" id="editReviewModal-btn" data-dismiss="modal"><i class="fa fa-floppy-o" aria-hidden="true"></i></button><br><br>
     			</div>
