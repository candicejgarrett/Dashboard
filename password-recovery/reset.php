  ...
  if ( $resetkey == $hash ) {
    ...
    if ( $password == $confirmpassword ) {
      if ( strlen( $password ) <= '8' ) {
        ...
        $mailbody = "Hello,<br><br>Your password has been successfully reset for the Dashboard: https://dashboard.coat.com/dashboard/. If you did not make this change, please contact <a href='mailto:candicejgarrett@gmail.com'>Candice Garrett</a> immediately.<br><br>" . $pwrurl . "<br><br>Thanks,<br> Administration - Candice Garrett";
  ...
  <div class="col-lg-12 text-center" style="height: 100%;">
    <center>
      <div class="whitebg min_height" id="pending" style="width: 400px;border-radius:0px;margin-top:15%">
        ...
        <center>
          <p style="color:#ff0000;text-align:center;font-weight:bold;" id="wrong"> <?php echo $message;?></p>
