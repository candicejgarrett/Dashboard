...
/////////// INSERTING ACTIVITY IN ACTIVITY FEED ///////////
	...
	//getting members
	$getProjectMember = "SELECT * FROM `user` WHERE `userID` = '$individual' AND `userID` != '$userID'";
	...
	$subject = "You have been added to the project: ".$projectTitle.".";
    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              Welcome to the project <span style="text-decoration: underline">'.$projectTitle.'</span>!
            </td>
          </tr>
          <tr>
            <td class="free-text">
    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              New task assigned to you in the project <span style="text-decoration: underline">'.$projectTitle.'</span>! 
            </td>
          </tr>
          <tr>
            <td class="free-text">
			 ...
			 <p class="pull-right"> <strong>Category: </strong>'.$taskCategory.'</p><p class="pull-left"> <strong>Due Date: </strong>'.date('m/d/Y @ g:i:sa',strtotime($finalTaskDueDate)).'</p>
        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
			 ...
			 <p class="pull-right"> <strong>Category: </strong>'.$categoryName.'</p><p class="pull-left"> <strong>Due Date: </strong>'.date('m/d/Y @ g:i:sa',strtotime($finalTaskDueDate)).'</p>
...
$connPDO = new PDO("mysql:host=$servername;dbname=$dbname", $serverusername, $serverpassword);
...
if ($connPDO->query($addRequest)) {
echo "<script type= 'text/javascript'>alert('New Record Inserted Successfully');</script>";
	
$RequestID = $connPDO->lastInsertId();
	
//Getting team members
	$getTeamMembers = "SELECT * FROM `Group Membership` WHERE `GroupID` = '1' AND `userID` != '$userID' AND `username` != 'CarolS'";
        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
			 ...
			 <p class="pull-right"> <strong>Category: </strong>'.$Category.'</p><p class="pull-left"> <strong>Go Live Date: </strong>'.date('m/d/Y @ g:i:sa',strtotime($DueDate1)).'</p>
