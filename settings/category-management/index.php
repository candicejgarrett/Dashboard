                ...
                <div class="tab-content">
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="createNewContainer">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-2">
                            <div class="formLabels">&nbsp;</div>
                            <div id="addNewGroup-btn" class="genericbtn green_bg">Add New</div>
                            <br>
                            <br>
                          </div>
                        </div>
                  ...
                  <div id="taskTypes" class="tab-pane fade">
                    <div class="col-sm-12">
                      ...
                      <div class="genericbtn showCreateNew" style="display:none;">Create New</div>
                      <br>
                      <div class="createNewContainer">
                        <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-2">
                            <div class="formLabels">&nbsp;</div>
                            <div id="addNewTaskType-btn" class="genericbtn green_bg">Add New</div>
                            <br>
                            <br>
                          </div>
                        </div>
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="createNewContainer">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-2">
                            <div class="formLabels">&nbsp;</div>
                            <div id="addNewProjectType-btn" class="genericbtn green_bg">Add New</div>
                            <br>
                            <br>
                          </div>
                        </div>
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="createNewContainer">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-2">
                            <div class="formLabels">&nbsp;</div>
                            <div id="addNewEvent-btn" class="genericbtn green_bg">Add New</div>
                            <br>
                            <br>
                          </div>
                        </div>
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="createNewContainer">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-2">
                            <div class="formLabels">&nbsp;</div>
                            <div id="addNewKC-btn" class="genericbtn green_bg">Add New</div>
                            <br>
                            <br>
                          </div>
                        </div>
