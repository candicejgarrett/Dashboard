	...
	<div class="row">
      ...
      <div class="row">
		 ...
		 <div class="col-sm-12">
			...
			<div class="row">
			<div class="col-sm-10 col-xs-offset-1 removeOffset">
				<br><br>
				<div class="row">
					<div class="col-sm-4">
						<div class="primaryGradientBG settingsIcon">
						<a href="send-alert">
						<h3>Send Out<br>Alert</h3>
					...
					<div class="col-sm-4">
						...
						<h3>Group/Category<br>Management</h3>
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="primaryGradientBG settingsIcon">
						<a href="activities-management/">
						<h3>Activities<br>Management</h3>
