      ...
      <div class="row">
		 ...
		 <div class="col-sm-12">
			...
			<div class="col-sm-6" id="styleCollumn">
				...
				<input type="hidden" id="typeStyle" value="style"></input>
				<div class="formLabels">Code (Include style tags):</div><textarea id="styleCode" placeholder=""><?php echo $styleCode?>
				</textarea>
			...
			<div class="col-sm-6" id="scriptCollumn">
				...
				<input type="hidden" id="typeScript" value="script"></input>
				<div class="formLabels">Code (Include script tags):</div><textarea id="scriptCode" placeholder="" value=""><?php echo $scriptCode?></textarea>
